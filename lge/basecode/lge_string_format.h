...
//         I64表示“64位”，对%d，当作I64；对%u，当作unsigned I64
//     specifier可以是以下内容：
//         c: 从参数表里面取一个字符，输出
...
public:
	...
	void AddArgument(int64 data);
	void AddArgument(uint64 data);
...
public:
	...
	CFormatHelper & operator << (int64 data);
	CFormatHelper & operator << (uint64 data);
